...
class Users(BaseAPI):
    ...
    def list(self, presence=False, limit=1000, cursor=None):
        return self.get('users.list', params={'presence': int(presence), 'limit': limit, 'cursor': cursor})
...
# You need to include the rest of the class definitions here, as in your original script.
# Due to space constraints, they are not fully listed here.
