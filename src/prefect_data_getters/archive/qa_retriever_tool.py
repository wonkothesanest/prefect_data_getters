...
slab_vecstore = Chroma(collection_name="slab_docs", persist_directory="slab_docs", embedding_function=embeddings_model)
slack_vecstore = Chroma(collection_name="slack_messages", persist_directory="slack_messages", embedding_function=embeddings_model)
